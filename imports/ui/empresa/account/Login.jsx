...
export const EmpresaLogin = () => {
  ...
  return (
  <div className="h-screen bg-neutral flex">
    <div className="w-1/2 my-auto">
      <article className="prose prose-xl mx-auto">
        <h1 className="text-center pt-16 pb-1 text-primary">Repbase</h1>
      </article>
      <article className="prose text-2xl text-white text-center mt-4">Empresas</article>
    </div>
    <div className="w-1/3  my-auto">
    <div className="px-4">
      <p className="text-center pt-8 text-white">Inicia sesión con tu usuario y contraseña.</p>
